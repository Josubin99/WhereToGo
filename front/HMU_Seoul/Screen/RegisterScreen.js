...
const RegisterScreen = (props) => {
    ...
    const handleSubmitButton = () => {
        ...
        AsyncStorage.setItem('user', JSON.stringify({'user_id':userId, 'user_pw':userPassword, 'user_name': userName, 'user_age':userAge}));
        console.log('success');
        ...
        <View style={styles.container}>
            ...
            <View style={styles.topArea}>
                <View style={styles.titleArea}>
                    <Text style={{fontSize:30, color: '#02343F',fontWeight:'bold'}}> 회원가입 </Text>
                </View>
            </View>
            ...
            <View style={styles.btnArea}>
                    <TouchableOpacity style={styles.btn} onPress={handleSubmitButton}>
                        <Text style={{color: '#F0EDCC', fontSize: wp('4%')}}>회원가입</Text>
                    </TouchableOpacity>
            </View>
        </View>
